...
BEGIN
 ...
 SELECT DISTINCT currency_id, currency_desc  FROM mashasilver.currency
 ...
 SELECT DISTINCT loc_id,loc_details,loc_region FROM mashasilver.locations
 ...
 SELECT DISTINCT prd_id,prd_desc,prd_size,prd_family,prd_sku,prd_seasons, prd_price,currency_desc FROM mashasilver.product
 ...
 SELECT DISTINCT dates,holidays FROM mashasilver.calendar
 ...
 SELECT DISTINCT dates,loc_id,prd_id,actuals_qty, prd_price, currency_id, actuals_sales, sales_forecast, currency_desc, location_details, loc_region, prd_desc, prd_size, prd_sku, prd_family,prd_seasons,holidays FROM mashasilver.actuals_qty
